...
public class ExternalPOMainDtoV7 {
	...
	public List<ExternalPOItemDtoV7> poItems;

	@JsonProperty("SCHEDULE_ITEM")
	public List<ExternalPODelivaryScheduleDtoV7> schedulePoItems;

	@JsonProperty("AMENDMENT")
	public List<ExternalPOItemPriceHistoryDtoV7> scheduleAmendments;

	@JsonProperty("SERVICE_ITEM")
	public List<ExternalPoItemServiceDtoV7> serviceItems;
