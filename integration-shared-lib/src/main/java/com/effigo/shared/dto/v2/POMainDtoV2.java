...
public class POMainDtoV2 {
	...
	public List<POItemDtoV2> poItems;

	@JsonProperty("poserviceitems")
	public List<PoItemServiceDtoV2> poServiceItems;

	@JsonProperty("schedulePoItems")
	public List<PODelivaryScheduleDtoV2> schedulePoItems;

	@JsonProperty("scheduleAmendments")
	public List<PurchaseOrderItemPriceHistoryDtoV2> scheduleAmendments;

	@JsonProperty("serviceItems")
	private List<PoItemServiceDtoV2> serviceItems;
