...
import com.effigo.shared.dto.v6.PoPriceTemplateStructureDtoV6;
...
public class ExternalPOItemDtoV6 {
    ...
    public List<PoPriceTemplateStructureDtoV6> poPriceTemplateStructureDtoV6s;

    @JsonProperty("POSCHEDULEITEMS")
    public List<ExternalPODelivaryScheduleDtoV6> externalPODelivaryScheduleDtoV6s;

	/*@JsonProperty("poserviceitems")
	public List<ExternalPoItemServiceDtoV2> poServiceItems;

	@JsonProperty("pricedetails")
	public List<ExternalPoPriceTemplateStructureDtoV2> priceDetails;*/
}
