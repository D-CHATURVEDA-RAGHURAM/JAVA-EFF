...
public class POMainDtoV6 {
    ...
    public List<POItemDtoV6> poItems;

    @JsonProperty("poserviceitems")
    public List<PoItemServiceDtoV6> poServiceItems;

    @JsonProperty("schedulePoItems")
    public List<PODelivaryScheduleDtoV6> schedulePoItems;

    @JsonProperty("scheduleAmendments")
    public List<PurchaseOrderItemPriceHistoryDtoV6> scheduleAmendments;

    @JsonProperty("serviceItems")
    private List<PoItemServiceDtoV6> serviceItems;

	/*@JsonProperty("podoc")
	public List<PODocDtoV2> poDoc;*/
}
