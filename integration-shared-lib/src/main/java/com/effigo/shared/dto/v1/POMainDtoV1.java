...
public class POMainDtoV1 {
    ...
    public List<POItemDtoV1> poItems;
    
    @JsonProperty("poserviceitems")
    public List<PoItemServiceDtoV1> poServiceItems;
    
    @JsonProperty("pricedetails")
    public ArrayList<PoPriceTemplateStructureDtoV1> priceDetails;
    
    @JsonProperty("schedule")
    public ArrayList<PODelivaryScheduleDtoV1> schedule;
    
    @JsonProperty("podoc")
    public ArrayList<PODocDtoV1> poDoc;
}
