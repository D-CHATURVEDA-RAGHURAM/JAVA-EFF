...
import com.effigo.shared.dto.v2.PODelivaryScheduleDtoV2;
import com.effigo.shared.dto.v2.POItemDtoV2;
import com.effigo.shared.dto.v2.PoItemServiceDtoV2;
import com.effigo.shared.dto.v2.PurchaseOrderItemPriceHistoryDtoV2;
...
public class POMainDtoV4 {
    ...
    public List<POItemDtoV4> poItems;

    @JsonProperty("poserviceitems")
    public List<PoItemServiceDtoV4> poServiceItems;

    @JsonProperty("schedulePoItems")
    public List<PODelivaryScheduleDtoV4> schedulePoItems;

    @JsonProperty("scheduleAmendments")
    public List<PurchaseOrderItemPriceHistoryDtoV4> scheduleAmendments;

    @JsonProperty("serviceItems")
    private List<PoItemServiceDtoV4> serviceItems;
