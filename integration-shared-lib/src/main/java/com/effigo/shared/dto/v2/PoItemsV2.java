...
public class PoItemsV2 {
  ...
  //  @JsonDeserialize(using = CustomDateTimeDeserializer.class)
    ...
    @JsonProperty("Srvpos")
    private String serviceItemCode= ""; // materialNumber
    @JsonProperty("Ktext1")
    private String cusField36= "";
    @JsonProperty("SerLgtxt")
    private String serviceLongText= "";
    @JsonProperty("Brtwr")
    private String brtwr= ""; // cusField13 * netPrice
    @JsonProperty("Smenge")
    private String serviceQty= ""; //poQty
    @JsonProperty("Smeins")
    private String serviceUom= "";// poUom
}
