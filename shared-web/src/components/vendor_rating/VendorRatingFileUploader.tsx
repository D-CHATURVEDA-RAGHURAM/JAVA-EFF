...
const VendorRatingFileUploader = ({
  getFile,
  fileType,
  token,
  success,
  ...
  return (
    <FilePond
      ...
      server={{
        process: {
          url: `${EFFIGO_MATERIAL_PRICE}effigo/api/grn/v1/varroc/addVendorRating?createdBy=${parsedToken.userId}`,
          method: "POST",
          headers: {
...
export default VendorRatingFileUploader;
