...
const ItemGrid = ({ columns, token, itemCode, close }: any) => {
  ...
  const fetchRows = async () => {
    ...
    try {
      const response: any = await axios.get(
        `${EFFIGO_MATERIAL_PRICE}effigo/api/grn/v1/kbl/getMaterialPriceHistoryDetails`,
        {
          params: {
            itemCode: itemCode,
          },
              ...
              <div className="gridToolbar">
                <div className="itemsButtonContainer">
                  <div className="breadcrumbs">
                    <div onClick={close}>Material Price Indices</div>
                    <div>{">"}</div>
