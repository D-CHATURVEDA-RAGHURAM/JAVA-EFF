...
git push https://bkujcnouykow62cspv7ni4s7q2hjtkjrdfcnd7cya6z257z3akfa@dev.azure.com/Effigo/Enterprise%20Apps/_git/payment-integration $NEW_TAG --tags --force --verbose